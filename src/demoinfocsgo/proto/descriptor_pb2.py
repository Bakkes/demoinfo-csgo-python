...
_SOURCECODEINFO_LOCATION.fields_by_name['path']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
_SOURCECODEINFO_LOCATION.fields_by_name['span'].has_options = True
_SOURCECODEINFO_LOCATION.fields_by_name['span']._options = _descriptor._ParseOptions(descriptor_pb2.FieldOptions(), '\020\001')
